...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Facebook (Meta) Pixel by Stape",
  "categories": [
    "ADVERTISING",
    "ANALYTICS",
    "CONVERSIONS",
  ...
  "description": "Tag that integrates Facebook Pixel into the page and allows easy tracking.",
  "containerContexts": [
    "WEB"
  ]
}
...
Created on 11/19/2024, 6:05:33 PM
